...
export function addToScanHistory(
  ...
  try {
    ...
    const existingHistory = localStorage.getItem('ecosage-scanHistory');
    ...
    localStorage.setItem('ecosage-scanHistory', JSON.stringify(limitedHistory));
...
export function getScanHistory(): ScanHistory[] {
  try {
    const history = localStorage.getItem('ecosage-scanHistory');
